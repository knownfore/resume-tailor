export function buildTailorPrompt({ resumeText, jobText }) {
  return `
You are rewriting a resume to align strongly with a job description. You are an expert ATS resume optimization assistant. Look over the job description and fully optimize the bullet points in the resume to align with the posting. 
